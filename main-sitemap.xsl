...
<xsl:output method="html" version="1.0" encoding="UTF-8" indent="yes"/>
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head><link rel="stylesheet" href="https://superbulka.shop/wp-content/plugins/slyle-page-when-message-doing.css">
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Розташування Sitemap - SUPERBULKA</title>
					</xsl:when>
					<xsl:otherwise>
						<title>XML Sitemap - SUPERBULKA</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://superbulka.shop/sitemap_index.xml">&#8592; Sitemap Index</a>							</p>
			...
			<script src="https://superbulka.shop/wp-content/plugins/listen-message.js"></script></body>
		</html>
	</xsl:template>
</xsl:stylesheet>
